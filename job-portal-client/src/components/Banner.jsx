...
const Banner = ({ query, handleInputChange }) => {
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      ...
      <form>
        <div className="flex justfy-start md:flex-row flex-col md:gap-0 gap-4">
          <div className="flex md:round-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus:within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full">
            <input
              ...
              className="block flex-1 border-0 bg-transparaent py-1.5 pl-8 text-white-900 placeholder:text-white-400 focus:right-0 sm:text-sm sm:leading-6"
