...
const Salary = ({handleChange,handleClick}) => {
  return (
    <div>
        ...
        <div className="flex">
<Button className="mr-2" onClickHandler={handleClick} value="" title="Hourly"/>
<Button className="mr-2" onClickHandler={handleClick} value="Monthly" title="Monthly"/>
<Button className="mr-2" onClickHandler={handleClick} value="Yearly" title="Yearly"/>
        </div>
    <div>
